...
A orquestra organismo

Ao grupo de pesquisa Poéticas tecnológicas

Ao IHAC

A Renata, Luisa e Lina pelo amor e dedicação diária
...
Os problemas conceituais resultantes da comparação
entre as atividades de composição e programação são melhor compreendidos ao longo
da exposição técnica de SInCoPA.

Num primeiro momento, a problemática se centra ao redor do ato composicional
através da computação e qual a relação das diferentes interfaces computacionais
com o pensamento criativo musical. Se faz necessária uma reflexão sobre 
as diferentes ferramentas e linguagens computacionais. Num segundo momento
