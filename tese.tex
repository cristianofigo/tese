...
mel-spacing can have a real impact on how relevant the features are in classifying one sound set vs. another. \cite{brentcepstral}
\end{quotation}
...
\begin{figure}
\includegraphics[scale=.28]{trab-fomus}
