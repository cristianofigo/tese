...
A atividade da rede, por exemplo, poderia ser ajustada para ser mínima ou densa gerando paisagens sonoras diferentes\footnote{
...
The activity of the network, for instance, could be tuned to be minimal or dense generating different sound landscapes''.} \cite{santiago}.
\end{quote}
%%%
...
O sistema \textit{pd2live} \cite{rickgrahan} considerado como um exemplo do estado da arte no desenvolvimento de sistemas interativos
que usam aprofunda alguns conceitos abstraídos da Gestalt e relacionados a estruturas de alturas
