...
O sistema apresentado nessa tese foi construído e deve rodar em um computador com capacidade de processamento
de áudio em tempo-real. O software é composto com
...
que as abstrações dependam, apenas da versão vanilla. A desvantagem de usar a distribuição Pd-extended é 
...
\begin{itemize}
 \item [tabletool] - Objeto para manipulação e operações matemáticas em arrays.
 \item [timbreID] - Série de objetos para análise e estimativa de parâmetros do timbre.
\end{itemize}
...
motivo 1 : customização do sistema para focar o processamento nas partes importantes

motivo 2 : compatibilidade futura - backup do sistema completo

motivo 3 : fácil distribuição do sistema desenvolvido nesse trabalho
para outros artistas/desenvolvedores
