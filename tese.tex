...
Na figura \ref{audio2midi} vemos o ambiente de trabalho que conecta
...
Uma limitação desse modelo está no fato de não ser possível sincronizar
automaticamente o controle do sequenciador no Rosegarden com o algoritmo
...
* explicar essas figuras

* o que não dá pra ser feito (ritmos e andamento)

* o que falta pra scriptar do pd direto no lilypond - external(?)
...
The emphasis so far has been to encapsulate all of the features of Western musical 
