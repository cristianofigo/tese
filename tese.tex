...
abstrações de módulos de processamento de sinal como \textit{delays}, distorções, e \textit{phase vocoder}.
...
A customização do sistema operacional para concentrar o processamento nas partes necessárias
