...
Every neural spike in SANTIAGO produces a rhythmic event, in contrast with regular artificial neural networks. 
...
Cada pico neural em SANTIAGO produz um evento rítmico, em contraste com regulares redes neurais artificiais.
Estes fluxos rítmicos pode variar de periódico ou quase-periódica polirhythmicity a caótica ou estocástica e também gerar.
Este comportamento resulta nem muito aleatória, nem muito uniforme e pode ser modificado de forma interativa como a rede evolui.
A atividade da rede, por exemplo, poderia ser ajustado para ser mínima ou densa gerando paisagens sonoras diferentes \cite{santiago}.

%%%


 
Os trabalhos atuais nesse campo incluem ao mesmo tempo a análise de áudio
...
Esse trabalho apresenta o desafio
...
% treinamento das redes, de acordo com a descrição gestáltica de sua própria percepção. 


%% pd2live

O sistema ``pd2live'' \cite{rickgrahan} considerado como um exemplo do estado da arte no desenvolvimento de sistemas interativos
aprofunda alguns conceitos abstraídos da Gestalt e relacionados a estruturas de alturas
de notas \cite{lerdahl2001} 
...
%% aqui concluir dizendo o que é bom no pd2live e o que pode ser ponto fraco e ressaltar o que SInCoPA
% contribui
