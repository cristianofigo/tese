...
se materializam em uma prática musical.
A poética implícita na criação de SInCoPA é resultado
de uma confluência de diversos vetores estéticos.

Nesta seção serão expostos os vetores que impulsionaram
o desejo de realização deste trabalho e que fazem parte 
de sua matriz estrutural. Alguns desses desejos/vetores
são de vertente técnica, enquanto que outros
pertencem ao mundo da política e comportamento. 


%% vetores estéticos:
%% 
%% 1) composição algorítmca
